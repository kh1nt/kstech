    ...
    public partial class AddPasswordResetTokens : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordResetTokens_Audience_ExpiresAtUtc_ConsumedAtUtc",
                table: "PasswordResetTokens",
                columns: new[] { "Audience", "ExpiresAtUtc", "ConsumedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordResetTokens_UserID_Audience_CreatedAtUtc",
                table: "PasswordResetTokens",
                columns: new[] { "UserID", "Audience", "CreatedAtUtc" });
        }
